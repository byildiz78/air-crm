...
type SettingsTab = 'users' | 'general' | 'points' | 'security' | 'notifications' | 'appearance'
...
export default function SettingsPage() {
  ...
  const settingsTabs = [
    ...
    },
    {
      ...
      title: 'Genel Ayarlar',
      description: 'Sistem geneli ayarları',
      icon: Settings,
      color: 'text-gray-600',
      bgColor: 'bg-gray-50'
    },
    ...
    },
    {
      ...
      title: 'Güvenlik',
      description: 'Güvenlik ve izinler',
      icon: Shield,
        ...
        return (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Sistem geneli ayarları buradan yapılandırabilirsiniz
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-center py-8">
                <Settings className="h-12 w-12 text-gray-300 mx-auto mb-4" />
                <p className="text-gray-500">Genel ayarlar yakında eklenecek</p>
              </div>
            </CardContent>
          </Card>
        )
        ...
        return (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Sistem güvenliği ve izin ayarları
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-center py-8">
                <Shield className="h-12 w-12 text-gray-300 mx-auto mb-4" />
                <p className="text-gray-500">Güvenlik ayarları yakında eklenecek</p>
              </div>
            </CardContent>
          </Card>
        )
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-center py-8">
                ...
                <p className="text-gray-500">Görünüm ayarları yakında eklenecek</p>
              </div>
            </CardContent>
          </Card>
        )
